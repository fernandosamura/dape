...
const useStyles = makeStyles((theme) => ({
  menuIcon: {
    color: theme.mode === "light" ? "#F5C300" : "#F5C300",
    minWidth: 40,
  },
  menuText: {
    "& span": {
  ...
  menuItem: {
    ...
    margin: "2px 6px",
    "&:hover": {
      backgroundColor: "rgba(245,195,0,0.12)",
    },
    "&.Mui-selected": {
      backgroundColor: "rgba(245,195,0,0.18)",
    },
  },
  ListSubheader: {
    height: 26,
...
function ListItemLink(props) {
  ...
  return (
    <li>
      <ListItem button dense component={renderLink} className={clsx(className, classes.menuItem)}>
          ...
          <>
            ...
            {showCampaigns && (
              <>
                ...
                >
                  <ListItemIcon style={{color: "#F5C300", minWidth: 40}}>
                    <EventAvailableIcon />
                  </ListItemIcon>
                  ...
                  />
                  {openCampaignSubmenu ? (
                    <ExpandLessIcon style={{color: "#F5C300"}} />
                  ) : (
                    <ExpandMoreIcon style={{color: "#F5C300"}} />
                  )}
                </ListItem>
                <Collapse
                ...
                >
                  <List component="div" disablePadding>
                    <ListItem onClick={() => history.push("/campaigns")} button>
                      ...
                      <ListItemText primary="Listagem" style={{color: "#fff"}} />
                    </ListItem>
                    <ListItem
                    ...
                    >
                      ...
                      <ListItemText primary="Listas de Contatos" style={{color: "#fff"}} />
                    </ListItem>
                    <ListItem
                    ...
                    >
                      ...
                      <ListItemText primary="Configurações" style={{color: "#fff"}} />
                    </ListItem>
                  </List>
                </Collapse>
                {/* Flow builder */}
                ...
                >
                  <List component="div" disablePadding>
                    ...
                    >
                      ...
                      <ListItemText primary="Campanha" style={{color: "#fff"}} />
                    </ListItem>
                    ...
                    >
                      ...
                      <ListItemText primary="Conversa" style={{color: "#fff"}} />
                    </ListItem>
                  </List>
                </Collapse>
              </>
